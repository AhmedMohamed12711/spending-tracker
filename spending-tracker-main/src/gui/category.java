...
public class category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Category");
        setBackground(new java.awt.Color(0, 158, 220));
...
//        Delete_btn.setBackground(Color.red);
    ...
    private void Clear_btnMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Clear_btnMouseMoved
        // TODO add your handling code here:
        Clear_btn.setBackground(Color.yellow);
    }//GEN-LAST:event_Clear_btnMouseMoved
    ...
    public static void main(String args[]) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            public void run() {
                ...
                JOptionPane.showMessageDialog(null, "sad to see you leave!, let use see you again ;-;");
                // Add your cleanup or closing actions here
            }
        });
