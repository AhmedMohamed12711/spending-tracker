...
//                dtm.setRowCount(0);
    ...
    private void Remove_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Remove_btnActionPerformed
        ...
        if (Table.getSelectedRow() != -1) {
            try {
                ...
                st.setInt(1, spending_id.get(Table.getSelectedRow()));
                System.out.println("Removed Id->" + spending_id.get(Table.getSelectedRow()));
                st.executeUpdate();
    ...
    private void Update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update_btnActionPerformed
        ...
        try {
            // TODO add your handling code here:
            PreparedStatement st = con.prepareStatement("update spending set category = ?, spending_date = ?, amount = ?, description = ?");
